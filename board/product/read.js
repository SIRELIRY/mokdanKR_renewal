document.addEventListener("DOMContentLoaded", function () {
  ...
  $scope
    .find(".headerMenu .btnSearch")
    .unbind("click.btnSearch")
    .bind("click.btnSearch", function () {
  ...
  $(".xans-layout-searchheader")
    ...
    .unbind("click.btnDelete")
    .bind("click.btnDelete", function () {
...
(function () {
  ...
  function dndComponent() {
    ...
    if ($navigation.length) {
      $(window)
        .bind("resize.calculateNavigationCategory", function () {
          if (calculateNavigationCategoryTimer)
            clearTimeout(calculateNavigationCategoryTimer);
          calculateNavigationCategoryTimer = setTimeout(
            calculateNavigationCategory,
            100
          );
        })
